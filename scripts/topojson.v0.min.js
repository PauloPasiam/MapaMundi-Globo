topojson = (function () {
  ...
  function e(e, r, o) {
    ...
    function s(t) {
      "GeometryCollection" === t.type
        ...
        : t.type in d && ((f = t), d[t.type](t.arcs));
    }
    var u = [];
  ...
  function n(t, e) {
    function n(t, e) {
      e.length && e.pop();
      for (
        var n, o = h[0 > t ? ~t : t], a = 0, i = o.length, c = 0, s = 0;
        i > a;
        ++a
      )
        e.push([(c += (n = o[a])[0]) * f + d, (s += n[1]) * l + p]);
      0 > t && r(e, i);
    }
    function o(t) {
      ...
      var e = t.type,
        n =
          "GeometryCollection" === e
            ? { type: e, geometries: t.geometries.map(s) }
            : e in v
            ? { type: e, coordinates: v[e](t) }
            : { type: null };
      return (
        "id" in t && (n.id = t.id),
        "properties" in t && (n.properties = t.properties),
        n
      );
    }
    var u = t.transform,
  ...
  function r(t, e) {
    for (var n, r = t.length, o = r - e; --r > o; )
      (n = t[o]), (t[o++] = t[r]), (t[r] = n);
  }
  function o(t, e) {
      ...
      t.forEach(function (t) {
        ...
        n[e] ||
          (n.forEach(function (t) {
            var n, r;
            (r = o((n = i[e]), t)),
              n[r] !== t && n.splice(r, 0, t),
              (r = o((n = i[t]), e)),
              n[r] !== e && n.splice(r, 0, e);
          }),
          (n[e] = e));
      });
    }
